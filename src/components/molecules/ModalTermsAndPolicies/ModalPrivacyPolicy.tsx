...
export function ModalPrivacyPolicy(props: ModalPrivacyPolicyProps) {
  return (
    <ModalContainer {...props}>
      ...
      <ModalBoxContainer>
        <ModalBox>
          <ModalBoxTitle>Políticas de privacidade do SouJunior</ModalBoxTitle>
          ...
          <ModalDescription>
            ...
            precisamos delas para lhe fornecer um serviço. Fazemos-lo por meios
            ...
            possamos fornecer alguns dos serviços desejados e caso aceite você
            poderá ainda, a qualquer tempo, retornar ao site, clicar políticas
            de privacidade e reler quantas vezes desejar. O uso continuado de
            ...
            <br /> O que são cookies?
            <br /> Como é prática comum em quase todos os sites profissionais,
            ...
            da funcionalidade do site. Como usamos os cookies? Utilizamos
            cookies por vários motivos, detalhados abaixo. Infelizmente, na
            maioria dos casos, não existem opções padrão do setor para desativar
            os cookies sem desativar completamente a funcionalidade e os
            recursos que eles adicionam a este site. É recomendável que você
            deixe todos os cookies se não tiver certeza se precisa ou não deles,
            caso sejam usados para fornecer um serviço que você usa. Desativar
            cookies Você pode impedir a configuração de cookies ajustando as
            ...
            Portanto, é recomendável que você não desative os cookies. Cookies
            ...
            poderão permanecer posteriormente para lembrar as preferências do
            ...
            página. Esses cookies são normalmente removidos ou limpos quando
            você efetua logout para garantir que você possa acessar apenas a
            recursos e áreas restritas ao efetuar login. Cookies relacionados a
            boletins por e-mail Este site oferece serviços de assinatura de
            ...
            seguir detalha quais cookies de terceiros você pode encontrar
            ...
            continuar produzindo conteúdo atraente. Para mais informações sobre
            cookies do Google Analytics, consulte a página oficial do Google
            Analytics. As análises de terceiros são usadas para rastrear e medir
            o uso deste site, para que possamos continuar produzindo conteúdo
            ...
            <br />O usuário se compromete a fazer uso adequado dos conteúdos e
            da informação que o SouJunior oferece no site e com caráter
            ...
            <ol className="list-style-type-none">
              ...
              <li>
                ...
                preconceituosa ou casas de apostas, jogos de sorte e azar,
