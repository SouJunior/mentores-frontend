    ...
    <FaqContainer>
      ...
      <AccordionContainer>
        ...
        <Accordion style={{ width: "699px" }}>
          ...
          <AccordionDetails>
            Qualquer pessoa que domine uma ou mais habilidades e especialidades
            disponibilizadas pela plataforma e queira contribuir com o
            desenvolvimento de outros profissionais compartilhando conhecimento
            e experiências.
          </AccordionDetails>
        </Accordion>
        <Accordion style={{ width: "699px" }}>
        ...
        <Accordion style={{ width: "699px" }}>
          ...
          <AccordionDetails>
            Um papo individual sobre as habilidades e especialidades que deseja
            desenvolver com o(a) mentor(a)
          </AccordionDetails>
        </Accordion>
        <Accordion style={{ width: "699px" }}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
