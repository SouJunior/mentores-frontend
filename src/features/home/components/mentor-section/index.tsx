...
export const MentorSection = ({
  ...
  return (
    <section id="mentor" className="bg-blue-25">
      <div className="container relative py-16 pr-0 max-[1440px]:max-w-none max-[1440px]:py-16 max-[1440px]:px-0 max-[438px]:py-14">
        <h2 className="text-black-200 text-[2.5rem] font-semibold leading-[120%] max-[1440px]:px-8 max-[1133px]:px-4 max-[768px]:text-[2rem]">
          Encontre seu mentor
        </h2>
        ...
        <div className="flex flex-col gap-6 mt-8">
          ...
          />
          <div className="flex self-center gap-6 [&_.arrow-slider]:text-blue-800 [&_.arrow-slider]:p-2 [&_.arrow-slider_svg]:w-6 [&_.arrow-slider_svg]:h-6">
            <Button
              variant="secondary"
              onClick={handlePrev}
