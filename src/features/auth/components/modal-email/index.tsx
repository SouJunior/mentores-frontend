...
export default function ModalEmail(props: ModalEmailProps) {
  return (
    <Modal.Content
      className="flex flex-col justify-center items-center relative w-full max-w-[25rem] bg-white shadow-card rounded-lg gap-6 px-14 pt-7"
      {...props}
    >
      <header className="flex flex-col items-center">
        ...
        <Modal.Description className="text-gray-700 text-base text-center leading-[150%] max-w-[15.5rem]">
